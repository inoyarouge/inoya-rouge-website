...
import type { Product, ProductVariant, Collection, Discount, VariantImage } from '@/lib/types'
...
export default async function ProductEditPage({
  ...
  if (!isNew) {
    ...
    variants = ((product_variants ?? []) as (ProductVariant & {
      ...
      .map(({ discounts: vd, variant_images, ...v }) => ({
        ...v,
        discount: normalizeDiscount(vd as Discount | Discount[] | null | undefined),
