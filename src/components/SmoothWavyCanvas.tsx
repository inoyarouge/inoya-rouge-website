...
const SmoothWavyCanvas = ({
    ...
    const animate = useCallback(() => {
        ...
        for (let i = 0; i < numPrimaryLines; i++) {
            ...
            const thickness = 1.5 + 1.0 * Math.sin(timeRef.current + i * 0.25) + mouseInfl * 1.5
            const opacity =
        ...
        for (let i = 0; i < numSecondaryLines; i++) {
            ...
            const thickness = 1.2 + 0.8 * Math.sin(timeRef.current + i * 0.35) + mouseInfl * 1.2
            const opacity =
        ...
        for (let i = 0; i < numAccentLines; i++) {
            ...
            const thickness = 1.0 + 0.6 * Math.sin(timeRef.current + i * 0.28)
